...
const shadows = [
    ...
    { name: 'sm', variable: '--shadow-sm', value: '0 1px 3px 0 rgb(28 25 23 / 0.08), 0 1px 2px -1px rgb(28 25 23 / 0.08)' },
    { name: 'md', variable: '--shadow-md', value: '0 4px 6px -1px rgb(28 25 23 / 0.08), 0 2px 4px -2px rgb(28 25 23 / 0.06)' },
    { name: 'lg', variable: '--shadow-lg', value: '0 10px 15px -3px rgb(28 25 23 / 0.08), 0 4px 6px -4px rgb(28 25 23 / 0.06)' },
    { name: 'xl', variable: '--shadow-xl', value: '0 20px 25px -5px rgb(28 25 23 / 0.08), 0 8px 10px -6px rgb(28 25 23 / 0.06)' },
